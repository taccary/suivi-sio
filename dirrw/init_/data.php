...
// Le 2nd champ correspond à la longueur utile (lngutile) pour l'affichage (left())
// Correction apostrophe (ASCII 27 plutôt que ASCII E28099) et longueur (prise en compte Unicode)
$requete["typologie"]=array(
"1,58,'Production d\'une solution logicielle et d\'infrastructure'",
"2,57,'Prise en charge d\’incidents et de demandes d\'assistance'",
"3,83,'Élaboration de documents relatifs à la production et à la fourniture de services'",
"4,54,'Mise en place d\'un dispositif de veille technologique'"
);
...
"2,1,'A1.1.2',65,'Étude de l\'impact de l\'intégration d\'un service sur le système informatique'",
"3,1,'A1.1.3',64,'Étude des exigences liées à la qualité attendue d\'un service'",
"4,2,'A1.2.1',64,'Élaboration et présentation d\'un dossier de choix de solution technique'",
"5,2,'A1.2.2',56,'Rédaction des spécifications techniques de la solution retenue (adaptation d\'une solution existante ou réalisation d\'une nouvelle solution)'",
"6,2,'A1.2.3',59,'Évaluation des risques liés à l\'utilisation d\'un service'",
"7,2,'A1.2.4',67,'Détermination des tests nécessaires à la validation d\'un service'",
"8,2,'A1.2.5',65,'Définition des niveaux d\'habilitation associés à un service'",
"9,3,'A1.3.1',51,'Test d\'intégration et d\'acceptation d\'un service'",
"10,3,'A1.3.2',70,'Définition des éléments nécessaires à la continuité d\'un service'",
"11,3,'A1.3.3',56,'Accompagnement de la mise en place d\'un nouveau service'",
"12,3,'A1.3.4',25,'Déploiement d\'un service'",
"13,4,'A1.4.1',26,'Participation à un projet'",
"14,4,'A1.4.2',65,'Évaluation des indicateurs de suivi d\'un projet et justification des écarts'",
"15,4,'A1.4.3',22,'Gestion des ressources'",
"16,5,'A2.1.1',67,'Accompagnement des utilisateurs dans la prise en main d\'un service'",
"17,5,'A2.1.2',51,'Évaluation et maintien de la qualité d\'un service'",
"18,6,'A2.2.1',32,'Suivi et résolution d\'incidents'",
"19,6,'A2.2.2',46,'Suivi et réponse à des demandes d\'assistance'",
"20,6,'A2.2.3',39,'Réponse à une interruption de service'",
"21,7,'A2.3.1',59,'Identification, qualification et évaluation d\'un problème'",
...
"25,8,'A3.1.3',64,'Prise en compte du niveau de sécurité nécessaire à une infrastructure'",
"26,9,'A3.2.1',59,'Installation et configuration d\'éléments d\'infrastructure'",
"27,9,'A3.2.2',63,'Remplacement ou mise à jour d\'éléments défectueux ou obsolètes'",
"28,9,'A3.2.3',65,'Mise à jour de la documentation technique d\'une solution d\'infrastructure'",
"29,10,'A3.3.1',66,'Administration sur site ou à distance des éléments d\'un réseau, de serveurs, de services et d\'équipements terminaux'",
"30,10,'A3.3.2',64,'Planification des sauvegardes et gestion des restaurations'",
"31,10,'A3.3.3',43,'Gestion des identités et des habilitations'",
...
"35,11,'A4.1.2',66,'Conception ou adaptation de l\'interface utilisateur d\'une solution applicative'",
"36,11,'A4.1.3',47,'Conception ou adaptation d\'une base de données'",
"37,11,'A4.1.4',60,'Définition des caractéristiques d\'une solution applicative'",
"38,11,'A4.1.5',35,'Prototypage de composants logiciels'",
"39,11,'A4.1.6',53,'Gestion d\'environnements de développement et de test'",
"40,11,'A4.1.7',65,'Développement, utilisation ou adaptation de composants logiciels'",
"41,11,'A4.1.8',65,'Réalisation des tests nécessaires à la validation d\'éléments adaptés ou développés'",
"42,11,'A4.1.9',41,'Rédaction d\'une documentation technique'",
"43,11,'A4.1.1',45,'Rédaction d\'une documentation d\'utilisation'",
"44,12,'A4.2.1',60,'Analyse et correction d\'un dysfonctionnement, d\'un problème de qualité de service ou de sécurité'",
"45,12,'A4.2.2',53,'Adaptation d\'une solution applicative aux évolutions de ses composants'",
"46,12,'A4.2.3',60,'Réalisation des tests nécessaires à la mise en production d\'éléments mis à jour'",
"47,12,'A4.2.4',42,'Mise à jour d\'une documentation technique'",
"48,13,'A5.1.1',45,'Mise en place d\'une gestion de configuration'",
"49,13,'A5.1.2',61,'Recueil d\'informations sur une configuration et ses éléments'",
"50,13,'A5.1.3',46,'Suivi d\'une configuration et de ses éléments'",
"51,13,'A5.1.4',66,'Étude de propositions de contrat de service (client, fournisseur)'",
"52,13,'A5.1.5',66,'Évaluation d\'un élément de configuration ou d\'une configuration'",
"53,13,'A5.1.6',44,'Évaluation d\'un investissement informatique'",
"54,14,'A5.2.1',52,'Exploitation des référentiels, normes et standards adoptés par le prestataire informatique'",
"55,14,'A5.2.2',20,'Veille technologique'",
"56,14,'A5.2.3',59,'Repérage des compléments de formation ou d\'auto-formation utiles à l\'acquisition de nouvelles compétences'",
"57,14,'A5.2.4',53,'Étude d‘une technologie, d\'un composant, d\'un outil ou d\'une méthode'"
);
